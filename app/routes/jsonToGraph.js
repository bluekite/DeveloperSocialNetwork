...
module.exports = function(app){
    ...
    app.post('/transform/wordpress/file/logic/circle/:version', function(req, res){

        var source,target,value;

        var network_row = fs.readFileSync('public/wordpress/network_file_logic_'+ req.params.version +'.json', 'utf-8');
        ...
        fs.writeFile('public/wordpress/circle_file_logic_'+req.params.version+'.json',JSON.stringify(graph,null,4), function(err){
            if(err){
                throw err;
